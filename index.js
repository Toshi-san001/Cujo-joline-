...
console.log(color('\nHello, I am Toshi, the main developer of this bot.\n\nThanks for using: Siesta','aqua'))
console.log(color('\nYou can follow me on GitHub: Toshi-san001','aqua'))

    let { version, isLatest } = await fetchLatestBaileysVersion()
    const Miku = MikuConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['Siesta by: Toshi','Safari','1.0.0'],
        auth: state,
        version
    })
...
I am *Siesta*, Welcome to ${metadata.subject}.
